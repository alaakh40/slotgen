function CAreYouSurePanel() {
    ...
    this._init = function () {
        ...
        _oMsg = new CTLText(_oContainerPanel, 
                    ...
                    70, "center", "#fede00", FONT_GAME_1, 1,
                    0, 0,
                    TEXT_ARE_SURE,
                    true, true, true,
                    false );
        ...
        _oButYes = new CGfxButton( oSpriteBg.width - 130,  304, s_oSpriteLibrary.getSprite('but_yes'), _oContainerPanel);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton( 130,  304, s_oSpriteLibrary.getSprite('but_no'), _oContainerPanel);
