function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        var oText = new CTLText(oContainerPage, 
                    1000, 366, 546, 118, 
                    36, "center", "#fede00", FONT_GAME_1, 1,
                    0, 0,
                    TEXT_HELP_BONUS1,
                    true, true, true,
                    false );
        ...
        var iYPos = 400;
        for(var j=0;j<3;j++){
            var oText = new createjs.Text((j+3)+"X  "+NUM_FREESPIN[j],"40px "+FONT_GAME_1, "#fede00");
        ...
        var oText = new CTLText(oContainerPage, 
                    ...
                    56, "center", "#fede00", FONT_GAME_1, 1,
                    0, 0,
                    TEXT_HELP_FREESPIN,
                    true, true, true,
                    false );
    ...
    this._createPayouts = function(oContainerPage){
        ...
        for(var i=0;i<PAYTABLE_VALUES.length;i++){
            ...
            for(var j=0;j<iLen;j++){
                ...
                var oText = new createjs.Text(aSymbolPayouts[iLen-j-1],"40px "+FONT_GAME_1, "#fede00");
