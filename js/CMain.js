function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'bonus_end_win',loop:false,volume:1, ingamename: 'bonus_end_win'});
        s_aSoundsInfo.push({path: './sounds/',filename:'character_jump',loop:false,volume:1, ingamename: 'character_jump'});
        s_aSoundsInfo.push({path: './sounds/',filename:'character_landing',loop:false,volume:1, ingamename: 'character_landing'});
        s_aSoundsInfo.push({path: './sounds/',filename:'soundtrack_bonus',loop:true,volume:1, ingamename: 'soundtrack_bonus'});
        s_aSoundsInfo.push({path: './sounds/',filename:'character_landing_pot',loop:false,volume:1, ingamename: 'character_landing_pot'});
        s_aSoundsInfo.push({path: './sounds/',filename:'character_falling',loop:false,volume:1, ingamename: 'character_falling'});
    ...
    this._loadImages = function(){
        ...
        for(var i=0;i<62;i++){
            s_oSpriteLibrary.addSprite("logo_"+i,"./sprites/logo/logo_"+i+".png");
        }
        ...
        for(var t=0;t<191;t++){
            s_oSpriteLibrary.addSprite("suspance_"+t,"./sprites/suspance/suspance_"+t+".png");  
        }
